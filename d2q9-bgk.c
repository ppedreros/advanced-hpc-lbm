...
int timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles)
{
  ...
  for (int jj = 0; jj < params.ny; jj++)
  {
    ...
    {
      int actual_cell_number = ii + jj*params.nx
      /*PROPAGATE STEP*/
      ...
      ** respecting periodic boundary conditions (wrap around) */
      ...
      int x_w = (ii == 0) ? (actual_cell_number - 1) : (ii - 1);
      /* propagate densities from neighbouring cells, following
      ** appropriate directions of travel and writing into
      ** scratch space grid */
      tmp_cells[actual_cell_number].speeds[0] = cells[actual_cell_number].speeds[0]; /* central cell, no movement */
      tmp_cells[actual_cell_number].speeds[1] = cells[x_w + jj*params.nx].speeds[1]; /* east */
      tmp_cells[actual_cell_number].speeds[2] = cells[ii + y_s*params.nx].speeds[2]; /* north */
      tmp_cells[actual_cell_number].speeds[3] = cells[x_e + jj*params.nx].speeds[3]; /* west */
      tmp_cells[actual_cell_number].speeds[4] = cells[ii + y_n*params.nx].speeds[4]; /* south */
      tmp_cells[actual_cell_number].speeds[5] = cells[x_w + y_s*params.nx].speeds[5]; /* north-east */
      tmp_cells[actual_cell_number].speeds[6] = cells[x_e + y_s*params.nx].speeds[6]; /* north-west */
      tmp_cells[actual_cell_number].speeds[7] = cells[x_e + y_n*params.nx].speeds[7]; /* south-west */
      tmp_cells[actual_cell_number].speeds[8] = cells[x_w + y_n*params.nx].speeds[8]; /* south-east */
      ...
      if (obstacles[jj*params.nx + ii])
      {
        ...
        ** mirroring, and writing into main grid */
        cells[actual_cell_number].speeds[1] = tmp_cells[actual_cell_number].speeds[3];
        cells[actual_cell_number].speeds[2] = tmp_cells[actual_cell_number].speeds[4];
        cells[actual_cell_number].speeds[3] = tmp_cells[actual_cell_number].speeds[1];
        cells[actual_cell_number].speeds[4] = tmp_cells[actual_cell_number].speeds[2];
        cells[actual_cell_number].speeds[5] = tmp_cells[actual_cell_number].speeds[7];
        cells[actual_cell_number].speeds[6] = tmp_cells[actual_cell_number].speeds[8];
        cells[actual_cell_number].speeds[7] = tmp_cells[actual_cell_number].speeds[5];
        cells[actual_cell_number].speeds[8] = tmp_cells[actual_cell_number].speeds[6];
      }

      /*COLISSION STEP*/
      /* don't consider occupied cells */
      else (!obstacles[actual_cell_number])
      {
        ...
        {
          local_density += tmp_cells[actual_cell_number].speeds[kk];
        }

        /* compute x velocity component */
        float u_x = (tmp_cells[actual_cell_number].speeds[1]
                      + tmp_cells[actual_cell_number].speeds[5]
                      + tmp_cells[actual_cell_number].speeds[8]
                      - (tmp_cells[actual_cell_number].speeds[3]
                         + tmp_cells[actual_cell_number].speeds[6]
                         + tmp_cells[actual_cell_number].speeds[7]))
                     / local_density;
        /* compute y velocity component */
        float u_y = (tmp_cells[actual_cell_number].speeds[2]
                      + tmp_cells[actual_cell_number].speeds[5]
                      + tmp_cells[actual_cell_number].speeds[6]
                      - (tmp_cells[actual_cell_number].speeds[4]
                         + tmp_cells[actual_cell_number].speeds[7]
                         + tmp_cells[actual_cell_number].speeds[8]))
                     / local_density;
        ...
        for (int kk = 0; kk < NSPEEDS; kk++)
        {
          cells[actual_cell_number].speeds[kk] = tmp_cells[actual_cell_number].speeds[kk]
                                                  + params.omega
                                                  * (d_equ[kk] - tmp_cells[actual_cell_number].speeds[kk]);
        }
      }
